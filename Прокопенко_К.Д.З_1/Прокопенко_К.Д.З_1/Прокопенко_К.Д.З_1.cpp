// Прокопенко_К.Д.З_1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CПрокопенко_КДЗ_1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CПрокопенко_КДЗ_1App::OnAppAbout)
...
// создание CПрокопенко_КДЗ_1App

CПрокопенко_КДЗ_1App::CПрокопенко_КДЗ_1App()
{
	...
	SetAppID(_T("Прокопенко_К.Д.З_1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CПрокопенко_КДЗ_1App

CПрокопенко_КДЗ_1App theApp;

// инициализация CПрокопенко_КДЗ_1App

BOOL CПрокопенко_КДЗ_1App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CПрокопенко_КДЗ_1Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CПрокопенко_КДЗ_1View));
	if (!pDocTemplate)
		return FALSE;
...
int CПрокопенко_КДЗ_1App::ExitInstance()
{
...
// обработчики сообщений CПрокопенко_КДЗ_1App
...
void CПрокопенко_КДЗ_1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
